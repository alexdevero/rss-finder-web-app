  ...
  return (
    <footer className="pb-3">
      ...
      <p className="h6 font-weight-normal text-center pt-1">
        Created by
        {' '}
        <a href="https://devero.io" target="_blank" rel="noopener noreferrer" className={`link-${state.isDarkModeOn ? 'light' : 'dark'}`}>Alex Devero</a>,
        {' '}
        <a href="https://devero.io" target="_blank" rel="noopener noreferrer" className={`link-${state.isDarkModeOn ? 'light' : 'dark'}`}>Devero Corp.</a>
      </p>
    </footer>
  )
}
